        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Informasi Detail Tahanan</h3>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped table-hover"> 
                        ...
                        <tr>
                         ...
                         <tr>
                            <td>Lama Tahanan</td> <td><?= $data['lama_tahanan'] ?></td>
                        </tr>
                ...
                <div class="panel-footer">
                    <a href="?page=tahanan&actions=tampil" class="btn btn-success btn-sm">
                        Kembali ke Data Tahanan </a>
