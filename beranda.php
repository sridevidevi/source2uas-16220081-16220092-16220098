    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SI Data Polsek Pulau Raja</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Berkas Data Polisi</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">NRP</th><th>Nama Lengkap</th><th>Pangkat</th><th>Jabatan</th><th>Alamat</th><th>Status Kasus</th>
                            </tr>
                            </tr>
                        </thead>
                        <tbody>
